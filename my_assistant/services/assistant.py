...
class Assistant:
    ...
    def is_workhour(self, date: datetime = None) -> bool:
        ...
        start_of_day = datetime(
            date.year, date.month, date.day, self.settings.start_hour, self.settings.start_minute
        )
        end_of_day = datetime(
            date.year, date.month, date.day, self.settings.end_hour, self.settings.end_minute
        ) + self.time_interval
