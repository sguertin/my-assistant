...
from my_assistant.services.ui.warning import warning_ok_cancel_prompt
    ...
    def manage_issues(self) -> tuple[bool, list[Issue]]:
        ...
        window = sg.Window(f'Time Tracking - Manage Issues', [
            ...
            [
                ...
                sg.Frame('', [
                    [sg.Button(
                        ' + ', key='-ADD-', size=(5, 1), tooltip='Add New Issue')],
                    [sg.Button(
                        ' <- ', key='-RESTORE-', size=(5, 1), tooltip='Restore Selected Issues')],
                    [sg.Button(
                        ' -> ', key='-REMOVE-', size=(5, 1), tooltip='Delete Selected Issues')]
                ]),
                deleted_list_box
            ],
            [
